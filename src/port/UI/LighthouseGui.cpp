...
namespace {
// Window-side changes reach the pref through its synced CVar.
...
void SetupGuiElements() {
    ...
    mGamepadMapperWindow = std::make_shared<Mapper::MapperWindow>(WindowPrefs::GamepadMapper.CVar(), "Gamepad Mapper",
                                                                  ImVec2(1280, 820));
